import type { Equal, Expect, IsTrue } from "@/utils.ts";
...
Deno.test("Tag", () => {
  ...
  type cases = [
    ...
    Expect<
      Equal<
        HasTags<Tag<Tag<Tag<{}, "foo">, "bar">, "baz">, ["foo", "bar"]>,
        true
      >
    >,
    Expect<
      Equal<
        HasTags<Tag<Tag<Tag<0, "foo">, "bar">, "baz">, ["foo", "bar"]>,
        true
      >
    >,
    Expect<
    ...
    >,
    Expect<
      Equal<HasTags<Tag<Tag<unknown, "foo">, "bar">, ["foo", "bar"]>, true>
    >,
